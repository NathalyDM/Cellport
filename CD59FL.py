...
sheet_name_golgi='CD59FL Golgi Exit'
...
Golgi_time_array,Golgi_array,Golgi_xlim_time=filtering_Golgi(golgi_time,golgi_MFI,int((10-8*step)/step),int((43-8*step)/step),0.5)
