...
def golgi_intra_transport(solution, A):
    ...
    while t<Tf :
        ...
        for k  in range(1,int(N)):
            ...
            A[0]=A[1]*(1-1 / n-kL/n)+AL/n+kL*Jon*dt
...
def start_ER(population_size, desired_output, generations_size, top_percentage, plot_TF=True):
    ...
    for chromosome in population:
        pop_error.append(f_error(chromosome, desired_output))
    ...
    for gen in range(generations_size - 1):
        ...
        for chromosome in population:
            ...
            pop_error.append(f_error(child, desired_output))
